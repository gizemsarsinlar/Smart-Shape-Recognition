...
if choice == 'Mission Statement':
    ...
    model0 = tf.keras.models.load_model('https://github.com/gizemsarsinlar/Smart-Shape-Recognition/blob/main/model_1.h5')
    ...
    #loading trained model for predicting
    model1 = tf.keras.models.load_model('https://github.com/gizemsarsinlar/Smart-Shape-Recognition/blob/main/model_1.h5')
    #setup for drag and drop to run prediction model
    st.subheader('Shape Recognition & Accuracy Checking')
    uploaded_file = st.file_uploader('Choose an image of a shape to classify...', type= ['png','jpg','jpeg'])
    if uploaded_file is not None:
    ...
    #loading trained model for predicting
    model2 = tf.keras.models.load_model('https://github.com/gizemsarsinlar/Smart-Shape-Recognition/blob/main/model_2.h5')
    #setup for drag and drop to run prediction model
    st.subheader('Shape Recognition & Accuracy Checking')
    uploaded_file = st.file_uploader('Choose an image of a shape to classify...', type= ['png','jpg','jpeg'])
    if uploaded_file is not None:
